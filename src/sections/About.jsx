...
const About = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: 'Specialized in React, Node.js, and Java. Skilled in RESTful APIs and databases.',
    },
  ];
      ...
      <div className="container">
        <div className="about-card fade-in" style={{ marginBottom: '40px' }}>
          ...
          <p className="section-description" style={{ textAlign: 'justify', lineHeight: '1.8', marginTop: '16px', width: '100%', maxWidth: '100%' }}>
            I am experienced in building responsive and scalable web applications using Node.js, Java, React, JavaScript, TypeScript, HTML5, CSS3, and Tailwind CSS. Skilled in developing RESTful APIs, working with MySQL, PostgreSQL, and MongoDB.
          </p>
          <p className="section-description" style={{ textAlign: 'justify', lineHeight: '1.8', marginTop: '16px', width: '100%', maxWidth: '100%' }}>
