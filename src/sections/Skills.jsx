...
const skillCategories = [
  ...
  },
  {
    ...
    icon: <FiLayers />,
    skills: [
      '.NET Framework', 'Spring Boot', 'Tailwind CSS', 'Bootstrap', 'Flask'
    ],
    color: '#ec4899',
  },
  {
    ...
    icon: <FiTool />,
    skills: [
      'Git', 'GitHub', 'Jupyter', 'Proteus', 'Linux', 'Blynk', 'Google Colab', 'Maven', 'Clickup', 'Figma', 'Notion', 'AWS', 'VS Code', 'IntelliJ', 'Postman', 'Visual studio', 'Jira'
    ],
    color: '#f59e0b',
  },
];
